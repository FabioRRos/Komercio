...
namespace Komercio.Services
{
    public class SaleFinalizerService
    {
        ...
        public SaleFinalizerService(CustomerService customerService, SaleService saleService, BindingList<SalesItensDTO> itensVenda, HttpClient httpClient = null)
        {
