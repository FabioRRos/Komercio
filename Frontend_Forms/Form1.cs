...
using Komercio.UI.Forms.ListaCompras;
...
namespace Komercio
{
    public partial class Home : Form
    {
        ...
        public Home(EmployeeService empliyeeService,
            ...
            SalesApp saleApp,
            DumpApp dumpApp,
            ListaComprasApp listaComprasApp,
            string httpClient)
        {
            InitializeComponent();
            // novo testamento
        ...
        {
            fmAlterarProduto alterarProduto = new fmAlterarProduto(null,_produtoApp);
        ...
        {
            var listaComprasForm = new frmAdicionarItensListaDeCompras(_listaComprasApp);
            listaComprasForm.ShowDialog();
        }
        ...
        private void editarListasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ListaCompras();
        }
